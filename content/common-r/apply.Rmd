...
`{function add1(x, y) x+y}`. Note that this alone does nothing in `R`. It has to be used in Map, Reduce, Filter, or another function that takes another function as an input argument. Note also that the first letter of these functions are capped.
